  ...
  return [
...

    {
      ...
      children: [
        ...
        { content: "Tailwind CSS", bold: true, className: "text-cyan-600 dark:text-cyan-400" },
        { content: " and ", bold: false },
        { content: "shadcn/ui", bold: true, className: "text-purple-600 dark:text-purple-400" },
...

    {
      ...
      children: [
        ...
        { content: "Select any text to format it, drag blocks to reorder them, and press ", italic: true },
        { content: "Shift+Enter", elementType: "code", bold: true },
        { content: " to create nested blocks. Have fun exploring!", italic: true },
      ],
      attributes: { 
...

    {
      ...
      children: [
        ...
        { content: " together! Mix and match to create beautiful content.", bold: false },
      ],
      attributes: {},
    } as TextNode,
      ...
      children: [
        ...
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: "rich text formatting", bold: true, className: "text-blue-600 dark:text-blue-400" },
...
const richParagraph = {
  ...
  children: [
...

    {
      ...
      type: "blockquote",
      children: [
        { content: "🤔 Wait, the block above looks a bit weird, right? ", italic: true },
        { content: "Oh! I wish I could add custom classes using normal Tailwind... ", italic: true, bold: true },
        { content: "Actually, you can! ", italic: true, className: "text-green-600 dark:text-green-400" },
        { content: "Select your text, then click the ", italic: true },
        { content: "pencil ✏️ smart icon", italic: true, bold: true },
        { content: ", and type your class or select from preset classes!", italic: true },
      ],
      attributes: {
      ...
      children: [
        {
          ...
          children: [
            ...
            { content: " - All Tailwind color shades (red, blue, green, etc.)", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
        ...
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Quick class lookup (e.g., 'text', 'bg', 'flex')", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
  ...
  children: [
...

    {
      ...
      children: [
        ...
        { content: "any Tailwind class", italic: true, bold: true, className: "text-blue-600 dark:text-blue-400" },
        { content: " including gradients, shadows, borders, spacing, and more! The Custom Class Popover is your gateway to ", italic: true },
        { content: "unlimited styling possibilities", italic: true, bold: true, className: "bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent" },
        { content: ".", italic: true },
      ],
      attributes: {
...

    {
      ...
      type: "p",
      children: [
        { content: "Red ", bold: true, className: "text-red-600 dark:text-red-400" },
        { content: "Orange ", bold: true, className: "text-orange-600 dark:text-orange-400" },
        { content: "Amber ", bold: true, className: "text-amber-600 dark:text-amber-400" },
        { content: "Yellow ", bold: true, className: "text-yellow-600 dark:text-yellow-400" },
        { content: "Lime ", bold: true, className: "text-lime-600 dark:text-lime-400" },
        { content: "Green ", bold: true, className: "text-green-600 dark:text-green-400" },
        { content: "Emerald ", bold: true, className: "text-emerald-600 dark:text-emerald-400" },
        { content: "Teal ", bold: true, className: "text-teal-600 dark:text-teal-400" },
        { content: "Cyan ", bold: true, className: "text-cyan-600 dark:text-cyan-400" },
        { content: "Sky ", bold: true, className: "text-sky-600 dark:text-sky-400" },
        { content: "Blue ", bold: true, className: "text-blue-600 dark:text-blue-400" },
        { content: "Indigo ", bold: true, className: "text-indigo-600 dark:text-indigo-400" },
        { content: "Violet ", bold: true, className: "text-violet-600 dark:text-violet-400" },
        { content: "Purple ", bold: true, className: "text-purple-600 dark:text-purple-400" },
        { content: "Fuchsia ", bold: true, className: "text-fuchsia-600 dark:text-fuchsia-400" },
        { content: "Pink ", bold: true, className: "text-pink-600 dark:text-pink-400" },
        { content: "Rose", bold: true, className: "text-rose-600 dark:text-rose-400" },
      ],
      attributes: {},
    } as TextNode,
...

    {
      ...
      children: [
        { content: "💡 Pro Tip: ", bold: true },
        { content: "Background colors work with any block type including headings, paragraphs, quotes, and code blocks!", italic: true },
      ],
      attributes: {
...

    {
      ...
      children: [
        ...
        { content: "Drag to reorder • Click to upload • Add captions • Responsive grid layout • Support for multiple formats (jpg, png, gif, webp)", italic: true },
      ],
      attributes: {},
    } as TextNode,
...

    {
      ...
      children: [
        ...
        { content: "Shift+Enter", elementType: "code", bold: true },
        { content: " to create nested blocks. Maximum nesting level is 1. Great for grouping related content together:", bold: false },
      ],
      attributes: {},
    } as TextNode,
      ...
      children: [
        {
          ...
          children: [
            ...
            { content: "nested container", bold: true, className: "text-blue-600 dark:text-blue-400" },
            { content: "! It groups related content together and can contain any block type.", bold: false },
          ],
          attributes: {
  ...
  children: [
    ...
    { type: 'blockquote', content: 'Quote in nest' }
...

        {
          ...
          type: "blockquote",
          children: [
            { content: "Even blockquotes work in nested containers! ", italic: true },
            { content: "Perfect for organizing complex content hierarchically.", italic: true, bold: true },
          ],
          attributes: {},
        } as TextNode,
...

    {
      ...
      children: [
        ...
        { content: "Reorder any block • Swap images in grids • Move blocks in and out of containers • Visual feedback during drag • Auto-scroll support", italic: true },
      ],
      attributes: {},
    } as TextNode,
...

    {
      ...
      children: [
        ...
        } as TextNode,
        {
          ...
          children: [
            { content: "Shift + Enter", elementType: "code", bold: true },
            { content: " - Create nested block or add to existing container", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
      ...
      children: [
        {
          ...
          children: [
            ...
            { content: " - Each element is an independent, draggable block", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Bold, italic, underline, and combinations", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - h1-h6, paragraph, code, blockquote, lists (ol/ul)", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
        ...
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Preset Tailwind colors + custom hex/RGB colors", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
        ...
        } as TextNode,
        {
          ...
          children: [
            { content: "✅ Background Colors", bold: true },
            { content: " - Apply backgrounds to any block with presets or custom colors", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Beautiful link popover with URL management", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Single images and grid layouts with drag-to-reorder", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Create containers for organizing related content", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Reorder blocks, swap images, reorganize everything", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Unlimited styling possibilities with full Tailwind support", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Clean, semantic HTML with preserved styling", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Fully typed API with excellent IntelliSense", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Built with reducers for predictable updates", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Full history management for all actions", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Perfect for displaying published content", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Beautiful themes that work everywhere", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Efficient editing with common shortcuts", bold: false },
          ],
          attributes: {},
        } as TextNode,
        {
          ...
          children: [
            ...
            { content: " - Right-click for quick actions (duplicate, delete, move)", bold: false },
          ],
          attributes: {},
        } as TextNode,
      ],
...
function App() {
  return (
...

    {
      ...
      children: [
        { content: "👉 ", bold: false },
        { content: "Select any text", bold: true, className: "text-blue-600 dark:text-blue-400" },
        { content: " and use the toolbar to format it with bold, italic, colors, fonts, and more", bold: false },
      ],
      attributes: {},
    } as TextNode,
...

    {
      ...
      children: [
        ...
        { content: " to reorder blocks and reorganize your document", bold: false },
      ],
      attributes: {},
    } as TextNode,

    {
      ...
      children: [
        ...
        { content: " mode in the top-right to see the read-only version", bold: false },
      ],
      attributes: {},
    } as TextNode,

    {
      ...
      children: [
        ...
        { content: "Dark Mode", bold: true },
        { content: " using the theme toggle for a different experience", bold: false },
      ],
      attributes: {},
    } as TextNode,
...

    {
      ...
      children: [
        ...
        { content: "Mina Rich Editor", bold: true, className: "text-purple-600 dark:text-purple-400" },
        ...
        { content: " and ", bold: false },
        { content: "shadcn/ui", bold: true, className: "text-purple-600 dark:text-purple-400" },
        { content: ". If you find it useful, please star the repository on GitHub and share it with other developers!", bold: false },
      ],
      attributes: {},
    } as TextNode,
